...
export class NewDirectBillPayment_Ext extends NewDirectBillPayment {
    ...
    overrideDistributionAmount_1 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-0-1-OverrideAmount')
    overrideDistributionAmount_2 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-1-0-OverrideAmount')
    overrideDistributionAmount_3 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-2-0-OverrideAmount')
    overrideDistributionAmount_4 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-3-0-OverrideAmount')
    overrideDistributionAmount_5 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-4-0-OverrideAmount')
    overrideDistributionAmount_6 = PcfTextInput ('#NewDirectBillPayment-EditDBPaymentScreen-DistributionAmountsLV-groups-5-0-OverrideAmount')
